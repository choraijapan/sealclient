...
function ScenePuzzle:init(...)
    ...
    local node = WidgetLoader:loadCsbFile('parts/game/GameCardNode.csb')
    node:setPosition(cc.p(0,cc.Director:getInstance():getWinSize().height/2 + 40))
